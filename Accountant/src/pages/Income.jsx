    ...
    <div className="min-h-screen bg-[#ecf0f5] text-[#333] p-4 sm:p-6 font-sans">
      ...
      <div className="flex flex-wrap gap-6 mb-8 text-[14px]">
        {[
          ...
          { label: 'Income', icon: ArrowDown, active: true, path: '/accounts/income' },
      ...
      <div className="bg-white rounded-[3px] border border-gray-200 shadow-sm flex flex-col mb-4">
        ...
        <div className="px-5 py-4 border-b border-gray-100 flex justify-between items-center bg-[#fefefe]">
          <div className="flex items-center gap-2">
            <ArrowDown className="w-5 h-5 text-[#5a52d7]" />
            <h2 className="text-[16px] font-bold text-[#333]">All Income Records</h2>
          </div>
              ...
              {incomeData.map((income, i) => (
                <tr key={income.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-4 px-5 border-l border-gray-100 text-gray-500">
                    {income.head ? (
                      <span className="bg-[#f2efff] text-[#5a52d7] font-semibold px-2.5 py-1 rounded-[3px] text-[11px] border border-[#dad6f9]">{income.head}</span>
                    ) : (
                      '--'
                    )}
                  </td>
                  <td className="py-4 px-5 border-l border-gray-100 text-gray-600">{income.date}</td>
      ...
      <div className="text-[12px] text-gray-500 pl-1">
        Showing 1 to {incomeData.length} of {incomeData.length}
      </div>
