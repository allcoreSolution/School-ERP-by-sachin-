...
const headsData = [
  ...
  { id: 2, name: 'Challan Collection', description: 'Auto-created for miscellaneous fee challan collections' },
  { id: 3, name: 'Donation', description: '--' },
  { id: 4, name: 'Miscellaneous', description: '--' },
  { id: 5, name: 'Miscellaneous1', description: '--' },
];
    ...
    <div className="min-h-screen bg-[#ecf0f5] text-[#333] p-4 sm:p-6 font-sans">
      ...
      <div className="flex flex-wrap gap-6 mb-8 text-[14px]">
        {[
          ...
          { label: 'Income Heads', icon: Tag, active: true, path: '/accounts/income-heads' },
      ...
      <div className="bg-white rounded-[3px] border border-gray-200 shadow-sm flex flex-col mb-4">
        ...
        <div className="px-5 py-4 border-b border-gray-100 flex justify-between items-center bg-[#fefefe]">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-[16px] font-bold text-[#333]">All Income Heads</h2>
          </div>
