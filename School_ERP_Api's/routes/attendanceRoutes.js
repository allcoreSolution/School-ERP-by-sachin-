...
const { markAttendance, getAttendanceByClass, getStudentAttendance, deleteAttendance, getQRScanLogs, getQRAttendanceReport } = require('../controllers/attendanceController');
...
router.get('/qr-scan-logs', getQRScanLogs);
router.get('/qr-report', getQRAttendanceReport);
