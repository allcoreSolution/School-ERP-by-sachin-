...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Auth login is now asynchronous!
    const ok = await login(form.email, form.password);
    if (ok) {
      navigate('/');
    } else {
      setError('Invalid email or password. Are you using correct admin credentials?');
      setLoading(false);
    }
  };
    ...
    <div className="h-screen overflow-hidden bg-white flex font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#1e282c] via-[#222d32] to-[#12181a] relative flex-col justify-between p-12 overflow-hidden items-start">
        ...
        <div className="relative z-10 w-full">
          <div className="w-14 h-14 bg-[#f39c12] rounded-lg flex items-center justify-center mb-6 shadow-lg shadow-[#f39c12]/20">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8 sm:px-12 bg-white relative z-10">
        ...
        <div className="w-full max-w-[400px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              ...
              <div className="relative group">
                <input 
                  ...
                  required
                  className="w-full border-2 border-gray-200 rounded-md pl-9 pr-4 py-2 bg-gray-50 focus:bg-white focus:outline-none focus:border-[#3c8dbc] text-slate-900 font-medium text-[14px] transition-colors"
                />
            ...
            <div>
              ...
              <div className="relative group">
                <input 
                  ...
                  placeholder="••••••••"
                  required
                  className="w-full border-2 border-gray-200 rounded-md pl-9 pr-4 py-2 bg-gray-50 focus:bg-white focus:outline-none focus:border-[#3c8dbc] text-slate-900 font-medium text-[14px] tracking-widest transition-colors"
                />
            ...
            {error && (
              <div className="text-red-500 text-xs font-semibold bg-red-50 px-3 py-2 rounded-md border border-red-200">
                {error}
              </div>
            )}
            ...
            <div className="flex items-center pt-1">
              <label className="flex items-center gap-2 cursor-pointer group">
                <div className="relative flex items-center justify-center">
                  ...
                  <div className="w-[15px] h-[15px] border-2 border-gray-300 rounded-sm bg-white peer-checked:bg-[#3c8dbc] peer-checked:border-[#3c8dbc] transition-colors flex items-center justify-center">
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-[#f39c12] hover:bg-[#e67e22] text-white py-2.5 rounded-md text-[14px] font-bold shadow-sm hover:shadow-md transition-all flex items-center justify-center gap-2 mt-1 disabled:opacity-70"
            >
              {loading ? (
